/**
 * ==============================================================================
 * VERIGRADE S3 — EXTENSIBLE ARDUINO & C/C++ HOOKS (arduino_hooks.h)
 * ==============================================================================
 * Architecture: ESP32-S3 / C99 / C++17
 * CLAIM MAP: Patent Claims 1, 9, 10, 23, 29
 *
 * Allows downstream developers to cleanly register hooks for:
 * - onItemGraded: Intercept every classified piece with raw sensor telemetry
 * - onCorrectionReceived: Dynamic feedback loop for AI model retraining
 * - onPriceTableUpdated: Scrap commodity rate changes
 * - onHazardDiverted: Instantaneous notice of shredder hazard ejections
 * ==============================================================================
 */
